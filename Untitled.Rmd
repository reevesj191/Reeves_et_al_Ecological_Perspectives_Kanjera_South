...
```
```{r fig-5, echo=FALSE,dpi= 1000,fig.height= 3, fig.width= 6, fig.cap= "Boxplots of the measures of flake efficiency. Y-axis represents perimeter of flakes divided by a logarithmically transformed mass value. \\label{flake_efficiency}"}
